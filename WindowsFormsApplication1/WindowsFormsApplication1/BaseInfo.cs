...

{
    ...
    class BaseInfo : IBaseInfo
    {
        ...
        /// <summary>
        /// Переводит базу знаний из формата JSON , сохраняет в списке правил. 
        /// </summary>
        public void Start()
        {
        ...
        /// <summary>
        /// Используется в том случае, если полностью меняется база знаний и она еще не была переведена в формат JSON.
        /// </summary>
        ...
        /// <summary>
        /// Переводит базу знаний в формат JSON.
        /// </summary>
        ...
        /// <summary>
        /// Извлекает базу знаний из формата JSON.
        /// </summary>
